...
public class ValidadorMedicoComOutraConsultaNoMesmoHorario implements ValidadorAgendamentoDeConsulta {
  ...
  public void validar(DadosAgendamentoConsulta dados) {
    ...
    // Fazemos uma consulta no banco de dados para verificar se o médico ja possui uma consulta nessa data. Apesar de parecer uma consulta um pouco mais complexa, podemos utilizar uma "Consulta Derivada" para para executar essa tarefa. Lembrando que a ordem dos parâmetros é importante, o "ByMedicoId" vem primeiro, logo o parâmetro com o id dele deve também ser o primeiro.
